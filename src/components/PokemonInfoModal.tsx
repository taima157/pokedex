import { Pokemon, NamedAPIResource, PokemonStat } from "pokenode-ts";
    ...
    <div className="fixed transition-opacity overflow-y-auto z-10 inset-0 w-screen h-screen flex justify-center sm:items-center">
      ...
      <div className="z-10 w-[98%] md:w-4/5 lg:w-3/5 xl:w-2/5 h-[90%] gap-5 border-2 border-neutral-900 flex flex-col rounded-lg bg-red-600 px-1 py-5 md:p-5">
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={toggleModal}
            className="w-10 h-10 duration-200 bg-neutral-800 rounded-xl p-2 border-2 border-neutral-700 "
          >
            <XMarkIcon className="h-full w-full text-neutral-200" />
          </button>
        </div>

        <div className="flex-1 flex flex-col px-1 md:px-5 pb-5 bg-neutral-300 border-2 border-neutral-900 rounded-md gap-2 md:gap-5 overflow-auto shadow-md shadow-black/80">
        ...
        <div className="flex w-full justify-between">
          <div className="flex gap-6">
            <div className="bg-neutral-800 shadow-md shadow-black/80 border-2 h-10 w-10 rounded-full border-neutral-900" />
            <div className="flex flex-col gap-5">
              <div className="flex gap-8">
                <div className="h-2 w-14 border-2 border-neutral-900 rounded-md shadow-md shadow-black/80" />
                <div className="h-2 w-14 border-2 bg-blue-900 border-neutral-900 rounded-md shadow-md shadow-black/80" />
              </div>

              <div className="flex p-2 w-full">
                <div className="w-full h-16 rounded-md shadow-md shadow-black/80 bg-green-600 border-2 border-neutral-900 " />
              </div>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex">
              <div className="w-10 h-10 bg-neutral-800 rounded-tl-md rounded-bl-md border-l-2 border-b-2 border-t-2 border-neutral-900 shadow-sm shadow-black/80" />
              ...
              <div className="w-10 h-10 bg-neutral-800 rounded-tr-md rounded-br-md border-r-2 border-b-2 border-t-2 border-neutral-900 shadow-sm shadow-black/80" />
            </div>

            <div className="w-10 h-10 bg-neutral-800 rounded-bl-md rounded-br-md border-l-2 border-r-2 border-b-2 border-neutral-900 shadow-sm shadow-black/80" />
          </div>
        </div>
      </div>
    </div>
